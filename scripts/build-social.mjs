...
await writeFile(resolve(root, "linkedin", "index.html"), shell("LinkedIn notes", "Field Notes are the long-form LinkedIn notes archive.", `<main class="content-main"><section class="content-hero"><p class="eyebrow"><span></span> LinkedIn / Field Notes</p><h1>Ideas worth <em>staying with.</em></h1><p class="content-lede">The LinkedIn notes archive: one content source, grouped by topic, with the original decks and sources where available.</p><label class="search-field content-search" for="note-search"><span class="sr-only">Search LinkedIn notes</span><input id="note-search" type="search" placeholder="Search notes, topics, and summaries" autocomplete="off" /><span aria-hidden="true">⌕</span></label></section><div class="topic-nav">${topics.map((topic) => `<a href="#${topic}">${escape(titleCase(topic))}</a>`).join("")}</div>${topicSections}<p class="empty-state" id="no-results" hidden>No notes match that search. Try a broader term.</p></main>`, { stylesheet: "../assets/site.css", script: "../assets/search.js", homeLink: "../", linkedinLink: "./", branchesLink: "../#platforms" }));
